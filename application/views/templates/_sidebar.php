...
<aside class="layout-sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <?php if (menu_group_visible(array('anggaran.dpa','anggaran.arus_kas','anggaran.realisasi','npd'))): ?>
    ...
    <?php if (menu_allowed('anggaran.realisasi')): ?><li class="menu-item"><a class="menu-link <?= $is('anggaran') && $seg2==='realisasi' ? 'active':'' ?>" href="<?= site_url('anggaran/realisasi') ?>"><i class="fa-solid fa-chart-line"></i><span>Realisasi (LRA)</span></a></li><?php endif; ?>
